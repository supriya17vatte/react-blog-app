...
const Headers = ({active,setActive,user,handleLogout}) => {
   ...
   <nav className="navbar navbar-expand-lg navbar-light bg-light">
    <div className="container-fluid bg-faded padding-media">
        <div className="container.padding-media">
           <nav className="nav.navbar.navbar-toggleable-md.navbar-light">
           <button className="navbar-toggler mt-3" type='button' data-bs-toggler="collapse" data-bs-target="#navbarSupportedContent"
